...
if (!isset($_GET['mahsulot_id'])) {
    redirect('index.php');
    
}

$product_id = sanitize($_GET['mahsulot_id']);
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <?php if (empty($product_variants)): ?>
            <div class="alert alert-info">Variant uchun mahsulotlar yoq</div>
        <?php else: ?>
                        ...
                        <?php foreach ($product_variants as $variant): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="text-muted">Rasm yoq</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if ($variant['rang']): ?>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-secondary">Yoq</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="update_variant.php" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Variant Rasmi</label>
...
<div class="modal fade" id="addVariantModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yangi variant qo'shish</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Rang kodi</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Mahsus narx</label>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="is_default_new">Birlamchi Variant</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Variant qo'shish </button>
                </div>
            </form>
        </div>
    </div>
